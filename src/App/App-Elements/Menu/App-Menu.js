                    ...
                    <div className="user-nav-container">
                        <nav className="user-navigation">
                            <div className="menu-closer" onClick={toggleMenuState}>
                                <svg title="close" alt="close" fill="#FFFFFF" style={{ width: '40px' }} viewBox="-8.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                    <title>close</title>
